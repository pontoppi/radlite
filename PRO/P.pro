...
FOR i=0,nctrans-1 DO BEGIN
   ...
   Clu_arr[i,*] = Cul_arr[i,*] * g[coll_iup[i]-1]/g[coll_idown[i]-1] * EXP(-(energy_in_k[coll_iup[i]-1]-energy_in_k[coll_idown[i]-1])/tgas_col)

   R_arr[coll_idown[i]-1,coll_iup[i]-1,*] = Cul_arr[i,*]*rhogas_col
   R_arr[coll_iup[i]-1,coll_idown[i]-1,*] = Clu_arr[i,*]*rhogas_col
ENDFOR
