;========================================================================
;         THIS FILE CONTAINS TWO DISK MODEL SETUP ROUTINES
;
; Model 1:  This is a simple 1-species model in which the sigma(R)
;           is parameterized by rdisk, sigma0, p1 and p2
; 
; Model 2:  This is a simple multi-species model in which sigma_i(rc)
;           is given as an array for multiple species. The rc grid
;           is not necessarily the same as the r,theta grid. Interpol
;           will be done. Rest the same as Model 1.
;========================================================================
