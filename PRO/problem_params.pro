...
;;  ['silicate.Kappa','forsterite.Kappa']
  ['amorph_mix.Kappa','cryst_mix.Kappa']
...
;--------------------------------------------------------------------------
nphot  = 100000         ; Nr of photons for RADMC
...
;; optical constants
;;
kuruczdir = homedir+'/science/kurucz/'
...
;;
src_rayt  = maindir+'/sources/raytrace/src'
src_rdmc  = maindir+'/sources/radmc/src'
src_chop  = maindir+'/sources/chopdens/src'
src_pahc  = maindir+'/sources/pahcode/src'
